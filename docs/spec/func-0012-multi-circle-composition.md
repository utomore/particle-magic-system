...
**新增**：`src/boundary/Magic/Scene.hs`、`test/ComposeSpec.hs`、`test/ComposeBudgetSpec.hs`、`test/SceneSpec.hs`、`test/CapacitySpec.hs`、`test/Acceptance12Spec.hs`、`docs/adr/adr-0012-multi-circle-scene.md`。
...
> 決策文件：[ADR-0012](../adr/adr-0012-multi-circle-scene.md)（合併律、配額政策、場作用域、上限選值）。
