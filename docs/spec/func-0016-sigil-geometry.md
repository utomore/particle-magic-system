...
description: 符文陣：陣形幾何由魔法陣的結構摘要導出
status: done
created: 2026-08-15
updated: 2026-08-16
...
**新增**：`src/core/Magic/Sigil.hs`、`test/SigilHashSpec.hs`、`test/SigilStrokeSpec.hs`、`test/SigilPlanSpec.hs`、`test/SigilWiringSpec.hs`、`test/Acceptance16Spec.hs`、`assets/spells/lattice-seal.json`、`docs/adr/adr-0014-sigil-from-circle-hash.md`。
