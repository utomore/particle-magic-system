...
**新增**：`app/App/Render/Sprite.hs`、`test/BatchSplitSpec.hs`、`test/ShapeVocabSpec.hs`、`test/SpriteSpec.hs`、`test/Acceptance15Spec.hs`、`assets/spells/soft-bloom.json`、`docs/adr/0013-billboard-vocabulary.md`。
