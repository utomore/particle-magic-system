...
**新增（8）**：`src/core/Magic/Space.hs`、`docs/adr/0019-spatial-summary-and-anchors.md`、`assets/spells/twin-lance.json`，＋`test/{SpaceBoundsSpec,OccupancySpec,AnchorCodecSpec,MultiAnchorSpec,SpaceInterfaceSpec,FFISpaceSpec,Acceptance25Spec}.hs`。
