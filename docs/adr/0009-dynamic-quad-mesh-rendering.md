...
- 狀態：已採納（2026-08-13）
- 相關：[architecture.md §7, §9.2](../architecture.md)、[ADR-0006](0006-soa-unboxed-buffer.md)（本 ADR 修訂其「FFI 零轉換」宣稱）、[func-spec 0005 §0.2](../func-spec/0005-render-observability.md)（實證調查紀錄）
