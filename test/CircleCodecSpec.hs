...
-- and @circleFields = []@ (spec 0007 §0.2): the phases and fields
-- roundtrip properties live in their own 'PhaseCodecSpec' /
-- 'FieldCodecSpec', so this generator's edit surface stays minimal.
